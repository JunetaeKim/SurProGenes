...
if __name__ == "__main__":
    ...
    for j in range(1, 6):
        ...
        MSavePoint = ModelCheckpoint(filepath='./Results/M04_RCFR_ACnosim_W'+str(AdjCosWeight_)+'_S'+str(j)+ '_Epo'+'{epoch:02d}'+ ".hdf5", save_weights_only=True, monitor='loss', mode='min',  save_best_only=False)
