...
def SetModel (NormDismInd, TrIndEmbeddMask, IndN, FeatN, ReferencePatIDLong, ReferencePatIDShort):
    ...
    Z = Dot(1,1)([IndEmbeddWeigBatch , FeatEmbeddWeigBatch])  * tf.reduce_max(FCosCLSimBatch, keepdims=True, axis=-1) + K.epsilon()
